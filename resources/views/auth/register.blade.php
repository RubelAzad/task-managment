...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Registration-Task Managment System</title>
        ...
        <div class="container">
          <div class="row">
            <div class="col col-login mx-auto">
                ...
                <form class="card" action="{{route('auth.registration')}}" method="POST">
                @csrf
                    <div class="card-body p-6">
                      <div class="card-title text-uppercase text-center">User Registration Form</div>
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control {{($errors->has('name'))?'is-invalid':''}}" name="name" value="{{old('name')}}" placeholder="Enter name...">
                        @if($errors->has('name'))
